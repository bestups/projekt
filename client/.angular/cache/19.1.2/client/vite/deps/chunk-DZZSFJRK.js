...
function getWeightBytelengthAsync(spec, slice2) {
  return __async(this, null, function* () {
    ...
    if ("quantization" in spec) {
      ...
      let byteLength = 0;
      for (let i = 0; i < size; i++) {
        byteLength += NUM_BYTES_STRING_LENGTH + new Uint32Array(yield slice2(byteLength, byteLength + NUM_BYTES_STRING_LENGTH))[0];
      }
      return byteLength;
    } else {
      bytesPerValue = DTYPE_VALUE_SIZE_MAP[spec.dtype];
...
function decodeWeightsStream(weightStream, specs) {
  return __async(this, null, function* () {
    ...
    for (const spec of specs) {
      const byteLength = yield getWeightBytelengthAsync(spec, (start, end) => __async(this, null, function* () {
...
@tensorflow/tfjs-core/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DZZSFJRK.js.map
